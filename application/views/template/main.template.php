...
<meta name="description" content="Calliope Free Template Developed by Towfiq I." />
<meta name="keywords" content="Free Template, Web Development" />
<link rel="shortcut icon" href="<?=base_url()?>images/favicon.gif" />
<link rel="stylesheet" type="text/css" href="<?=base_url()?>css/style.css" />
<script type="text/javascript" src="<?=base_url()?>js/swfobject/swfobject.js"></script>
<script type="text/javascript">
		var flashvars = {};
		flashvars.xml = "<?=base_url()?>config.xml";
		flashvars.font = "<?=base_url()?>font.swf";
		var attributes = {};
		attributes.wmode = "transparent";
		attributes.id = "slider";
		swfobject.embedSWF("<?=base_url()?>cu3er.swf", "cu3er-container", "960", "270", "9", "expressInstall.swf", flashvars, attributes);
</script>
...
<div id="header">
	<div class="center">
	<div id="logo"><a href="<?=base_url()?>">Calliope</a></div>
		<!--Menu Begin-->
		<div id="menu">
		<ul>
...
<div id="midrow">
	<div id="container">
		...
		<p><a>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eget consequat odio. Proin sapien erat, venenatis ut mollis vel, pulvinar in eros. Cras vel felis massa, a vulputate leo.</a><br /><br />
...
<div id="bottomrow">
		...
		<div class="feed">
		<a href="#"><img alt="Twitter" src="<?=base_url()?>images/twitter.jpg" height="80" width="75" title="Twitter" /></a>
		<a href="#"><img alt="RSS" src="<?=base_url()?>images/rss.jpg" height="80" width="67" title="RSS" /></a>
		</div>
</div>
